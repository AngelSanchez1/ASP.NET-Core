...
namespace Curso_De_ASP_NET_Core.Models
{
    public class EscuelaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var asignaturas = CargarAsignaturas(cursos, 5);
        ...
        private static List<Asignatura> CargarAsignaturas(List<Curso> cursos, int cantidad)
        {
            ...
            return listaCompleta.Take(cantidad).ToList();
        }
        ...
        private static List<Curso> CargarCursos(Escuela escuela)
        {
            return new List<Curso>()
            {
                        new Curso() {
                            ...
                            Dirección = "Calle de Pixeles" },
                        new Curso() {Id = Guid.NewGuid().ToString(), EscuelaId = escuela.Id, Nombre = "201",
                            Dirección = "Calle de Pixeles" , Jornada = TiposJornada.Mañana},
                        new Curso   {Id = Guid.NewGuid().ToString(), EscuelaId = escuela.Id, Nombre = "301",
                            Dirección = "Calle de Pixeles" , Jornada = TiposJornada.Mañana},
                        new Curso() {Id = Guid.NewGuid().ToString(), EscuelaId = escuela.Id, Nombre = "401",
                            Dirección = "Calle de Pixeles" , Jornada = TiposJornada.Tarde },
                        new Curso() {Id = Guid.NewGuid().ToString(), EscuelaId = escuela.Id, Nombre = "501",
                            Dirección = "Calle de Pixeles" , Jornada = TiposJornada.Tarde},
            };
        }
